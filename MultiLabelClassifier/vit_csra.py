...
* Weights ported from official jax impl for 384x384 base and small models_local, 16x16 and 32x32 patches.
...
class VIT_CSRA(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.num_features = self.embed_dim = embed_dim  # num_features for consistency with other models_local
