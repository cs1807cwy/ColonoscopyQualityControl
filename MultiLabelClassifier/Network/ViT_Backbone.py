...
__all__ = ['ViT_B_Patch16_224_Extractor', 'ViT_L_Patch16_224_Extractor', 'Swinv2_L_Window12_192_Extractor', 'ViT_L_Patch14_336_Extractor']


class ViT_B_Patch16_224_Extractor(nn.Module):
    def __init__(self, pretrained: bool):
        super(ViT_B_Patch16_224_Extractor, self).__init__()
